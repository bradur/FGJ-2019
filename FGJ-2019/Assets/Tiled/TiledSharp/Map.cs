...
namespace TiledSharp
{
    public class TmxMap : TmxDocument
    {
        ...
        public List<string> GetTilesetPaths() {
            List<string> tilesetPaths = new List<string>();
            foreach(XElement xElement in xMap.Elements("tileset")) {
                tilesetPaths.Add((string) xElement.Attribute("source"));
            }
            return tilesetPaths;
        }
    }
